...
<section id="welcome" class="p-b-0">
    <div class="container">
        ...
        <div class="row" data-animate="fadeInUp">
            <div class="col-lg-12">
                <img class="img-fluid" src="{{ asset('frontend/images/other/responsive-1.jpg')}}" alt="Welcome to POLO">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="portfolio-item-wrap">
                    <div class="portfolio-slider">
                        <div class="carousel dots-inside dots-dark arrows-dark" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay="1500">
                            <a href="#"><img src="{{ asset('frontend/images/portfolio/64.jpg')}}" alt=""></a>
                            <a href="#"><img src="{{ asset('frontend/images/portfolio/70.jpg')}}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
