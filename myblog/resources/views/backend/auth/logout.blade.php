            ...
            <div class="card-body">
                ...
                <div class="auth-brand text-center text-lg-start">
                    <a href="/" class="logo-dark">
                        <span><img src="backend/images/logo-dark.png" alt="" height="18"></span>
                    </a>
                    <a href="/" class="logo-light">
                        <span><img src="backend/images/logo.png" alt="" height="18"></span>
                    </a>
                </div>
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Back to <a href="backend/auth/login" class="text-muted ms-1"><b>Log In</b></a></p>
                </footer>
